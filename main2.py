...
target_colors_hex = ["#f6efef", "#a7a7a4", "#4b483e", "#4d4b47", "#352f27", "#c5c5c5", "#858583"]  # Цвета серых элементов
...
class AutoClicker:
    def __init__(self, hwnd, target_colors_hex, nearby_colors_hex, target_colors_hex_2, freeze_colors_hex, threshold, logger, target_percentage, collect_freeze, windowIsWeb):
        self.hwnd = hwnd
...
if __name__ == "__main__":
    ...
    windowIsWeb = "Web" in windows[choice][0];
    while True:
        try:
    ...
    logger = Logger("[https://t.me/way_to_whales]")
    ...
    auto_clicker = AutoClicker(hwnd, target_colors_hex, nearby_colors_hex, target_colors_hex_2, freeze_colors_hex, threshold, logger, target_percentage, collect_freeze, windowIsWeb)
    try:
